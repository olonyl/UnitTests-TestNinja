...
namespace TestNinja.UnitTests.Mocking
{
    class BookingHelper_OverlappingBookingsExistTests
    {
        ...
        [Test]
        public void BookingStartsBeforeAndFinishesInTheMiddleOfExistingBooking_ReturnExistingBookinReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingStartsAndFinishesAfterExistingBooking_ReturnExistingBookingReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
